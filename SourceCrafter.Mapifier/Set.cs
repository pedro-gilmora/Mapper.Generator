...
public abstract class Set<TValue> : IEnumerable<TValue>
{
    public static Set<TValue> Create<TKey>(
        ...
        IEqualityComparer<TKey>? comparer = null) => new Set<TKey, TValue>(keyGenerator, comparer);
...
{
    private readonly Func<TKey, int> _getHashCode = _comparer is null
    ...
    private readonly Func<TKey, TKey, bool> _equals = _comparer is null
